...
set -e
    ...
    wp core install --url="https://ekose.42.fr" --title="My WordPress Site" --admin_user="ertu" --admin_password=$MYSQL_ROOT_PASSWORD --admin_email="ekose@example.com" --allow-root
